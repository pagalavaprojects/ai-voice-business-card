...
| **Last updated** | 2026-08-08 (second pass: persistent pitch-audio storage + browser-TTS fallback, WhatsApp Cloud API notifier scaffold, Vercel functions co-located with the Sydney database via vercel.json regions) |
